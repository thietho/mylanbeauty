...
class ControllerLayoutHome extends Controller
{
	public function index()
	{
		...
		$this->data['meta_description'] = $this->document->setup['Description']." ".$this->document->meta_description;
		$this->data['meta_keyword'] = $this->document->setup['Keyword']." ".$this->document->meta_keyword;
		//

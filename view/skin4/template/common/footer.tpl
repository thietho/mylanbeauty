<div id="hl-page-sileder">
    ...
    <div>
        <ul id="hl-sitemap">
            <li><a href="<?php echo HTTP_SERVER?>" data-transition="fade" data-ajax="false">Trang chủ</a></li>
            ...
            <li><a href="<?php echo @$this->document->createLink('ortherbrand')?>" data-transition="fade" data-ajax="false">Các nhãn hiệu khác</a></li>
    ...
    <div>
        <ul id="hl-categories">
            ...
            <li><a href="<?php echo @$this->document->createLink($sitemap['sitemapid'])?>" title="<?php echo @$sitemap['sitemapname']?>" data-transition="fade" data-ajax="false"><?php echo @$sitemap['sitemapname']?></a></li>
                <?php } ?>
            <?php } ?>
        </ul>
    </div>
